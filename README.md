...
This test bootstrap contains Pi Matrix Signage v0.6.21. The next commercial-hardening stage should move the application payload out of the public bootstrap repository and retrieve a signed, licence-authorised release package from the ISSL/WHMCS licensing service.
...
- Bundles Pi Matrix Signage v0.6.21.
