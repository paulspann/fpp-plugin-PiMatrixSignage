# Pi Matrix Signage FPP Plugin v0.1.29
...
This test bootstrap contains Pi Matrix Signage v0.6.59. The next commercial-hardening stage should move the application payload out of the public bootstrap repository and retrieve a signed, licence-authorised release package from the ISSL/WHMCS licensing service.



## v0.1.28

- Bundles Pi Matrix Signage **v0.6.59** with fixed geometric seven- and fourteen-segment LED text displays.
