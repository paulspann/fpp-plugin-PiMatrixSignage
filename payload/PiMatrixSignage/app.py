...
BUILTIN_HARDWARE_PROFILES = (
    # Hanson rPi-MFC starters. These are hidden automatically when no physical
    # rPi-MFC is detected on the controller.
    {"id": -1, "name": "Hanson · P5 64×32 · 1×1 · 64×32", "builtin": True, "config": {"panel_output_type": "rpi_mfc", "panel_model": "P5 64×32 (verify scan)", "panel_width": 64, "panel_height": 32, "panel_scan": "1/16", "panels_across": 1, "panels_down": 1, "display_rotation": 0, "color_order": "RGB", "brightness": 60, "colorlight_receiver_model": "5a-75b", "colorlight_interface": "eth1"}},
    {"id": -2, "name": "Hanson · P5 64×32 · 2×1 · 128×32", "builtin": True, "config": {"panel_output_type": "rpi_mfc", "panel_model": "P5 64×32 (verify scan)", "panel_width": 64, "panel_height": 32, "panel_scan": "1/16", "panels_across": 2, "panels_down": 1, "display_rotation": 0, "color_order": "RGB", "brightness": 60, "colorlight_receiver_model": "5a-75b", "colorlight_interface": "eth1"}},
    {"id": -3, "name": "Hanson · P5 64×32 · 4×1 · 256×32", "builtin": True, "config": {"panel_output_type": "rpi_mfc", "panel_model": "P5 64×32 (verify scan)", "panel_width": 64, "panel_height": 32, "panel_scan": "1/16", "panels_across": 4, "panels_down": 1, "display_rotation": 0, "color_order": "RGB", "brightness": 60, "colorlight_receiver_model": "5a-75b", "colorlight_interface": "eth1"}},
    {"id": -4, "name": "Hanson · P5 64×32 · 2×2 · 128×64", "builtin": True, "config": {"panel_output_type": "rpi_mfc", "panel_model": "P5 64×32 (verify scan)", "panel_width": 64, "panel_height": 32, "panel_scan": "1/16", "panels_across": 2, "panels_down": 2, "display_rotation": 0, "color_order": "RGB", "brightness": 60, "colorlight_receiver_model": "5a-75b", "colorlight_interface": "eth1"}},

    # Colorlight receiver-card starters.
    {"id": -5, "name": "Colorlight 5A-75B · P5 64×32 · 2×1 · 128×32", "builtin": True, "config": {"panel_output_type": "colorlight", "panel_model": "P5 64×32 (verify scan/driver)", "panel_width": 64, "panel_height": 32, "panel_scan": "1/16", "panels_across": 2, "panels_down": 1, "display_rotation": 0, "color_order": "RGB", "brightness": 60, "colorlight_receiver_model": "5a-75b", "colorlight_interface": "eth1"}},
    {"id": -6, "name": "Colorlight 5A-75B · P5 64×32 · 4×1 · 256×32", "builtin": True, "config": {"panel_output_type": "colorlight", "panel_model": "P5 64×32 (verify scan/driver)", "panel_width": 64, "panel_height": 32, "panel_scan": "1/16", "panels_across": 4, "panels_down": 1, "display_rotation": 0, "color_order": "RGB", "brightness": 60, "colorlight_receiver_model": "5a-75b", "colorlight_interface": "eth1"}},
    {"id": -7, "name": "Colorlight 5A-75B · P5 64×32 · 2×2 · 128×64", "builtin": True, "config": {"panel_output_type": "colorlight", "panel_model": "P5 64×32 (verify scan/driver)", "panel_width": 64, "panel_height": 32, "panel_scan": "1/16", "panels_across": 2, "panels_down": 2, "display_rotation": 0, "color_order": "RGB", "brightness": 60, "colorlight_receiver_model": "5a-75b", "colorlight_interface": "eth1"}},
    {"id": -8, "name": "Colorlight 5A-75E · P5 64×32 · 4×2 · 256×64", "builtin": True, "config": {"panel_output_type": "colorlight", "panel_model": "P5 64×32 (verify scan/driver)", "panel_width": 64, "panel_height": 32, "panel_scan": "1/16", "panels_across": 4, "panels_down": 2, "display_rotation": 0, "color_order": "RGB", "brightness": 60, "colorlight_receiver_model": "5a-75e", "colorlight_interface": "eth1"}},
    {"id": -9, "name": "Colorlight 5A-75E · P10 32×16 · 4×2 · 128×32", "builtin": True, "config": {"panel_output_type": "colorlight", "panel_model": "P10 32×16 (verify scan/driver)", "panel_width": 32, "panel_height": 16, "panel_scan": "1/4", "panels_across": 4, "panels_down": 2, "display_rotation": 0, "color_order": "RGB", "brightness": 60, "colorlight_receiver_model": "5a-75e", "colorlight_interface": "eth1"}},
    {"id": -10, "name": "Colorlight 5A-75E · P10 32×16 · 8×2 · 256×32", "builtin": True, "config": {"panel_output_type": "colorlight", "panel_model": "P10 32×16 (verify scan/driver)", "panel_width": 32, "panel_height": 16, "panel_scan": "1/4", "panels_across": 8, "panels_down": 2, "display_rotation": 0, "color_order": "RGB", "brightness": 60, "colorlight_receiver_model": "5a-75e", "colorlight_interface": "eth1"}},

    # Adafruit direct-HUB75 starters. HAT/Bonnet uses one directly-connected
    # panel in the supported starter set; Triple/Active3 uses three parallel
    # strings and the 3×2 examples assume two panels per string.
    {"id": -11, "name": "Adafruit HAT/Bonnet · P5 64×32 · 1 panel", "builtin": True, "config": {"panel_output_type": "adafruit_hat", "panel_model": "P5 64×32 (verify scan)", "panel_width": 64, "panel_height": 32, "panel_scan": "1/16", "panels_across": 1, "panels_down": 1, "display_rotation": 0, "color_order": "RGB", "brightness": 60, "colorlight_receiver_model": "5a-75b", "colorlight_interface": "eth1"}},
    {"id": -12, "name": "Adafruit HAT/Bonnet · P10 32×16 · 1 panel", "builtin": True, "config": {"panel_output_type": "adafruit_hat", "panel_model": "P10 32×16 (verify scan)", "panel_width": 32, "panel_height": 16, "panel_scan": "1/4", "panels_across": 1, "panels_down": 1, "display_rotation": 0, "color_order": "RGB", "brightness": 60, "colorlight_receiver_model": "5a-75b", "colorlight_interface": "eth1"}},
    {"id": -13, "name": "Adafruit Triple · P5 64×32 · 3×1 · 192×32", "builtin": True, "config": {"panel_output_type": "adafruit_triple", "panel_model": "P5 64×32 (verify scan/layout)", "panel_width": 64, "panel_height": 32, "panel_scan": "1/16", "panels_across": 3, "panels_down": 1, "display_rotation": 0, "color_order": "RGB", "brightness": 60, "colorlight_receiver_model": "5a-75b", "colorlight_interface": "eth1"}},
    {"id": -14, "name": "Adafruit Triple · P5 64×32 · 3×2 · 192×64", "builtin": True, "config": {"panel_output_type": "adafruit_triple", "panel_model": "P5 64×32 (verify scan/layout)", "panel_width": 64, "panel_height": 32, "panel_scan": "1/16", "panels_across": 3, "panels_down": 2, "display_rotation": 0, "color_order": "RGB", "brightness": 60, "colorlight_receiver_model": "5a-75b", "colorlight_interface": "eth1"}},
    {"id": -15, "name": "Adafruit Triple · P10 32×16 · 3×1 · 96×16", "builtin": True, "config": {"panel_output_type": "adafruit_triple", "panel_model": "P10 32×16 (verify scan/layout)", "panel_width": 32, "panel_height": 16, "panel_scan": "1/4", "panels_across": 3, "panels_down": 1, "display_rotation": 0, "color_order": "RGB", "brightness": 60, "colorlight_receiver_model": "5a-75b", "colorlight_interface": "eth1"}},
    {"id": -16, "name": "Adafruit Triple · P10 32×16 · 3×2 · 96×32", "builtin": True, "config": {"panel_output_type": "adafruit_triple", "panel_model": "P10 32×16 (verify scan/layout)", "panel_width": 32, "panel_height": 16, "panel_scan": "1/4", "panels_across": 3, "panels_down": 2, "display_rotation": 0, "color_order": "RGB", "brightness": 60, "colorlight_receiver_model": "5a-75b", "colorlight_interface": "eth1"}},
)
