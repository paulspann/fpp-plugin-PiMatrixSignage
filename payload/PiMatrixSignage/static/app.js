(() => {
  ...
  function updateAnimationFieldVisibility(){
    ...
    $('splitFlapOptions').classList.toggle('hidden',!flap);$('advancedTextEffectOptions').classList.toggle('hidden',!advanced);
  }
