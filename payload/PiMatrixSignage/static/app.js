(() => {
  ...
  function defaultTextLayer(name='Text'){
    ...
    return Object.assign(l,{text:'YOUR MESSAGE',font:'',font_size:Math.max(8,Math.round(h*.7)),auto_fit:true,wrap:false,overflow:'manual',text_transform:'none',line_display:'together',typewriter_speed:12,flap_cycles:4,flap_stagger:.06,flap_order:'left',flap_board_style:'none',flap_bg_color:'#171717',flap_seam_color:'#000000',flap_border_color:'#454545',flap_cell_gap:1,flap_case_padding:2,effect_amount:2,effect_stagger:.08,color:'#ffffff',color2:'#ff00ff',color_effect:'none',color_speed:1,color_palette:'#ff0000,#ffff00,#00ff00,#00aaff',glow:0,glow_color:'#ffffff',outline_color:'#000000',outline_width:0,padding:1,align:'center',valign:'middle',line_spacing:.12,shadow_color:'#000000',shadow_x:0,shadow_y:0,render_mode:'pixel',pixel_scale:1,pixel_bold:false,letter_spacing:0});
  }
