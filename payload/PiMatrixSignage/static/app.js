(() => {
  ...
  function updateNixieTextControls(){
    const nixie=$('layerAnimation').value==='nixie';
    ['layerFont','layerFontSize','layerAutoFit','layerWrap','layerRenderMode','layerPixelScale','layerPixelBold','layerLetterSpacing','layerTextTransform','layerLineDisplay'].forEach(id=>{const el=$(id);if(el)el.disabled=nixie;});
